...
@Tag(name = "CRUD REST APIs for card in EazyBank",
...
public interface ICardController {
    ...
    @PostMapping("/create")
    ResponseEntity<ResponseDto> createCard(@Valid @RequestBody CardDto dto);
    ...
    public ResponseEntity<ResponseDto> delete(@RequestParam("mobileNumber")
                                                  @Pattern(regexp = "(^$|[0-9]{10})", message = "CardNumber must be 10 digits")
                                                  String mobileNumber);
}
